...
package mt // import "golang.speech.sogou.com/apis/mt/v1"
...
func (*TranslateTextRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_mt_2c17684a004d17f5, []int{0}
}
...
type TranslateConfig struct {
	...
	// set to one of the language codes listed in [Language Support](https://docs.speech.sogou.com/docs/mt/resources/languages).
...
func (*TranslateConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_mt_2c17684a004d17f5, []int{1}
}
...
func (dst *TranslateConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TranslateConfig.Merge(dst, src)
}
...
func (*TranslateTextResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_mt_2c17684a004d17f5, []int{2}
}
...
func init() { proto.RegisterFile("sogou/speech/mt/v1/mt.proto", fileDescriptor_mt_2c17684a004d17f5) }

var fileDescriptor_mt_2c17684a004d17f5 = []byte{
