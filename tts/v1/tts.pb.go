...
package tts // import "golang.speech.sogou.com/apis/tts/v1"
...
func (AudioConfig_AudioEncoding) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_tts_d8821420fc99c89d, []int{4, 0}
}
...
func (*SynthesizeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tts_d8821420fc99c89d, []int{0}
}
...
func (*SynthesizeConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_tts_d8821420fc99c89d, []int{1}
}
...
func (dst *SynthesizeConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SynthesizeConfig.Merge(dst, src)
}
...
func (*SynthesisInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_tts_d8821420fc99c89d, []int{2}
}
...
func (*VoiceConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_tts_d8821420fc99c89d, []int{3}
}
...
func (dst *VoiceConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VoiceConfig.Merge(dst, src)
}
...
func (*AudioConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_tts_d8821420fc99c89d, []int{4}
}
...
func (*SynthesizeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tts_d8821420fc99c89d, []int{5}
}
...
func init() { proto.RegisterFile("sogou/speech/tts/v1/tts.proto", fileDescriptor_tts_d8821420fc99c89d) }

var fileDescriptor_tts_d8821420fc99c89d = []byte{
